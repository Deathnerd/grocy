...
<div class="card">
	...
	<div class="card-body">
		...
		@if(getenv("GROCY_FEATURE_FLAG_STOCK_LOCATION_TRACKING"))<strong>{{ $__t('Default location') }}:</strong> <span id="productcard-product-location"></span><br>@endif
		...
		@if(getenv("GROCY_FEATURE_FLAG_STOCK_PRICE_TRACKING"))<strong>{{ $__t('Last price') }}:</strong> <span id="productcard-product-last-price"></span><br>@endif
		@if (getenv("GROCY_FEATURE_FLAG_STOCK_BEST_BEFORE_DATE_TRACKING"))<strong>{{ $__t('Average shelf life') }}:</strong> <span id="productcard-product-average-shelf-life"></span><br>@endif
