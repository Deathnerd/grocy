			...
			<tbody class="d-none">
				...
				<tr>
					<td class="fit-content border-right">
						...
						<a class="btn btn-danger btn-sm user-delete-button @if($user->id == getenv("GROCY_USER_ID")) disabled @endif" href="#" data-user-id="{{ $user->id }}" data-user-username="{{ $user->username }}">
